    ...
    const handlePublish = async () => {
        ...
        try {
            ...
            if (error.response && error.response.data && error.response.data.errors) {
                ...
                setAlertMessage('There were some errors with your submission.');
            } else {
                setAlertMessage('An error occurred while creating the post.');
            }
            setShowAlert(true);
                        ...
                        <div className="modal-body">
                            ...
                            <form>
                                ...
                                <div className="mb-3 textLine">
                                    ...
                                    <input type="text" className="form-control" id="title-input" value={title} onChange={(e) => handleInputChange(e, setTitle)} />
                                </div>
                                <div className="mb-3 textLine">
                                    <label htmlFor="description-input" className="col-form-label">Description:</label>
                                    <textarea className="form-control" id="description-input" value={description} onChange={(e) => handleInputChange(e, setDescription)}></textarea>
                                </div>
                            </form>
                        </div>
